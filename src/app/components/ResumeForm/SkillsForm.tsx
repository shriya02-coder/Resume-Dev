    ...
    <Form form={form}>
      <div className="col-span-full grid grid-cols-6 gap-3">
        ...
        >
          ...
          The "Featured Skills" section serves as an optional platform to showcase your primary competencies, where a greater number of circles signifies higher proficiency.
          </p>
        </InputGroupWrapper>
